...
contract DXTSale is owned{
    ...
    function DXTSale(IMyContract _tokenContract,uint256 precio,uint256 precio1,uint256 precio2,uint256 precio3) public {
        ...
        price = precio * 1 finney;//0.1 finney;
        price1 = precio1* 1 finney;
        price2 = precio2* 1 finney;
        price3 = precio3* 1 finney;
        start = now;
        MES1 = start + (DIA_SEG*1); //tiempo mes 1 deberia ser 31 seteable despues en setMeses
        MES2 = start + (DIA_SEG*2);//tiempo mes 2 deberia ser 61
        MES3 = start + (DIA_SEG*3);//tiempo mes 3 deberia ser 92
    }
